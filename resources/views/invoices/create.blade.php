        ...
        <form id="invoiceForm" action="{{ route('invoices.store') }}" method="POST" @submit.prevent="validateAndSubmit">
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="bg-gradient-to-r from-[#003686] to-blue-800 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                    <div>
                        <h1 class="text-[#003686] text-2xl sm:text-3xl font-bold mb-1">Create Invoice</h1>
                        <p class="text-[#ff6701] text-sm">Generate a new invoice for your client</p>
                    </div>
                ...
                <div class="p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mt-4">
                            <button type="button" 
                                    @click="addItem"
                                    class="inline-flex items-center px-4 py-3 bg-[#003686] border-l-4 border-[#ff7601] text-white rounded-lg font-medium transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 w-full sm:w-auto justify-center">
